...
GPIO.setup(encoder_pin11, GPIO.IN)
...
try:
    flag = True
    while True:
        if (GPIO.input(encoder_pin11) == GPIO.HIGH) and flag == True: 
            flag = False
            print("1")
        elif (GPIO.input(encoder_pin11) == GPIO.LOW) and flag == False:
            flag = True
            print("0")

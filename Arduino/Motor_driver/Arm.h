...
class Arm{
  public:
    ...
    bool Move_series(int motion_size);
    bool fantasyBaby();
    ...
    bool is_singular(float desire_y, float desire_z, float desireAngle_array[]);
